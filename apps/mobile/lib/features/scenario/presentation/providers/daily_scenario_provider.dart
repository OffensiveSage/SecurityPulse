...
///
/// Currently uses [MockScenarioRepository] for all modes because the
/// backend API is not yet deployed. Switch to [ApiScenarioRepository]
/// once the backend is live and set the base URL via environment config.
